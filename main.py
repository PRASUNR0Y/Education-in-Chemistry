        ...
        if not self.element in element:
            ...
            return (
                "{}{}{}\n\n{} ELEMENT   : {}\n{} APPEARANCE: {}\n{} SYMBOL    : {}\n{} NUMBER    : {}\n{} PERIOD    : {}\n{} PHASE     : {}\n{} ATOMIC MASS: {}\n{} BOILING pt: {}\n{} MELTING Pt: {}\n{} CATEGORY  : {}\n{} DENSITY    : {}\n{} MOLAR HEAT  : {}\n{} CONFIGURATION : {}\n{} AFFINITY    : {}\n{} ELECTRONEGATIVITY : {}\n{} IONIZATION e  : {}\n{} Xpos    : {}\n{} Ypos    : {}\n{} SHELLS   : {}\n{} DISCOVERED BY: {}\n{} NAMED BY  : {}\n\n\n{} {}\n\n{}".format(
                    ...
                    pro, self.element, pro, ell['appearance'],
                    pro, ell['symbol'], pro, ell['number'], pro,
                    ell['period'], pro, ell['phase'], pro,
                    ell['atomic_mass'], pro, ell['boil'], pro,
                    ell['melt'], pro, ell['category'], pro,
                    ell['density'], pro, ell['molar_heat'],
                    pro, ell['electron_configuration'],
                    pro, ell['electron_affinity'], pro,
                    ell['electronegativity_pauling'],
                    pro, ell['ionization_energies'],
                    pro, ell['xpos'], pro, ell['ypos'],
                    pro, ell['shells'],
                    pro, ell['discovered_by'],
                    pro, ell['named_by'],
                    pro, ell['summary'],
